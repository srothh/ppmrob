...
import planner.msg  # The action specification generates several messages for sending goals, receiving feedback, etc... This line imports the generated messages.


class CommandAction(object):
    # create messages that are used to publish feedback/result
    _feedback = planner.msg.CommandFeedback()
    _result = planner.msg.CommandResult()
    ...
    def execute_cb(self, goal):
        ...
        for i in range(1, 5):  # in tut: goal.order
