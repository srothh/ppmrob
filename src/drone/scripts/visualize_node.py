...
pos_current, = ax1.plot(0, 0, "x", color="blue", alpha=0.8)
...
azimuth_current = ax4.arrow(0,0,0,0)
#ax4.plot([0,np.deg2rad(0)], [0,1], color='red')
ax4.fill_between(np.linspace(0, 0, 100), 0, 1, color='lightblue', alpha=0.9)
...
def update(frame_number):
    ...
    return [target_current, target_history, pos_current, pos_history, azimuth_current, image_current, battery_current[0]]
